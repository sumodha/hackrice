...
const AboutPage = () => {
    return (
        <div id= "about">
            ...
            <p><b>Accessibility</b> – Break down barriers so that anyone can understand and access support.</p>
            <p><b>Connection</b> – Bridge the gap between people in need and the programs that serve them.</p>
            <p><b>Empowerment</b> – Give individuals and families the tools they need to thrive, not just survive.</p>
            <p>We’re more than a website — we’re a network of care, working to ensure that no one falls through the cracks.</p>
        </div>
    );
}
